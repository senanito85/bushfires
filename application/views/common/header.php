...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url("includes/assets/css/animate.css") ?>">
    <link rel="stylesheet" href="<?php echo base_url("includes/assets/css/main.css") ?>">
...
<body>
    ...
    <header class="top">
        ...
        <!-- Nav section Ended -->
        <img class="border-img" src="<?php echo base_url("includes/assets/images/border.png") ?> " width="100%" alt="">
    </header>
