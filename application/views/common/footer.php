        ...
        <div class="copyright">
            <div class="container">
                <div class="row border-img">
                    <div class="col-md-12">
                        <img src="<?php echo base_url("includes/assets/images/border.png") ?>" alt="">
                    </div>
                </div>
            </div>
            <div class="container">
    ...
    <!-- Custom JavaScript -->
    <script src="<?php echo base_url("includes/assets/js/animate.js") ?>"></script>
    <script src="<?php echo base_url("includes/assets/js/custom.js") ?>"></script>
</body>
