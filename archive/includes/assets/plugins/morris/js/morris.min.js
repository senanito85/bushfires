...
(function() {
    ...
    b = window.Morris = {}, a = jQuery, b.EventEmitter = function() {
        ...
        function d(b) {
            ...
            var c = this;
            if (this.el = "string" == typeof b.element ? a(document.getElementById(b.element)) : a(b.element), null == this.el || 0 === this.el.length)  return;
        ...
        function d(c) {
            ...
            if (this.options = a.extend({}, this.defaults, c), this.el = "string" == typeof c.element ? a(document.getElementById(c.element)) : a(c.element), null === this.el || 0 === this.el.length) return;
